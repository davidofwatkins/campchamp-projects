...
header("Location: " . $protocol . $domainName .  $this->webroot . "halls"); ?>
<p>If your browser does not automatically redirect you, please <a href="<?= $this->webroot; ?>login">click here</a></p>
