		...
		miniColors: function(o, data) {
			...
			var show = function(input) {
				...
				selector
					...
					.css({
						top: input.is(':visible') ? input.offset().top + input.outerHeight() : input.data('trigger').offset().top + input.data('trigger').outerHeight() - ($(".miniColors-trigger").outerHeight() * 1.5),
